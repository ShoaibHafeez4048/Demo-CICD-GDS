...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds4048")
    bq_project = Variable.get("bq_project", default_var="smart-arc-459310-g9")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                ...
                "network_uri": "projects/smart-arc-459310-g9/global/networks/default",
                "subnetwork_uri": "projects/smart-arc-459310-g9/regions/us-east1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="smart-arc-459310-g9",
        region="us-east1",
